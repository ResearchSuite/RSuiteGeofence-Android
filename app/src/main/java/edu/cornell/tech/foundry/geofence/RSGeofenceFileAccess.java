...
public class RSGeofenceFileAccess extends SimpleFileAccess implements RSTBStateHelper, OhmageOMHSDKCredentialStore {

    private String pathName;

    private static String SIGNED_IN_DATE = "SIGNED_IN_DATE";

    public static RSGeofenceFileAccess getInstance()
    {
        return (RSGeofenceFileAccess) StorageAccess.getInstance().getFileAccess();
    }

    public RSGeofenceFileAccess(String pathName)
    {
